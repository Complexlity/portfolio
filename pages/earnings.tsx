...
const Earnings = () => {
  ...
  const earnings = [
    ...
    },
    {
      ...
      description: "Contact details and social profiles for Bountycaster cofounder, Linda Xie",
      links: [
        "mailto:linda@scalar.capital",
        "https://www.linkedin.com/in/lindaxie",
        "https://x.com/lindaxie",
        "https://farcaster.xyz/linda",
      ],
      linkLabels: ["Email (new)", "LinkedIn", "Twitter", "Farcaster"],
    },
    {
      title: "OpenReplay Blog Profile",
